...
import nam.gor.machineryleasing.models.exceptions.EntityValidationException;
...
import nam.gor.machineryleasing.models.exceptions.ExceptionBody;
...
public class ExceptionController {
    private static final String GENERIC_SERVER_ERROR_BODY_MESSAGE =
    ...
    public ResponseEntity<ExceptionBody> handleEntityNotFoundException(EntityNotFoundException e) {
        log.error(
                "An attempt to access an unknown resource was made: {}",
                e.getMessage(),
                e);
    ...
    public ResponseEntity<ExceptionBody> handleEntityValidationException(EntityValidationException e) {
        log.error(
                "An attempt to modify or create a resource with invalid data was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
    ...
    public ResponseEntity<ExceptionBody> handleDuplicateEmailException(DuplicateEmailException e) {
        log.error(
                "An attempt to create a user with existing email was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
    ...
    public ResponseEntity<ExceptionBody> handleEmailNotFoundException(EmailNotFoundException e) {
        log.error(
                "An attempt to login with a not found email was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
    ...
    public ResponseEntity<ExceptionBody> handleIncorrectPasswordException(
            IncorrectPasswordException e) {
        log.error(
                "An attempt to login with a wrong password was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
                .status(HttpStatus.UNAUTHORIZED)
    ...
    public ResponseEntity<ExceptionBody> handleInvalidTokenException(
            InvalidTokenException e) {
        log.error(
                "An attempt to perform a request with " +
                        "an invalid token was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
                .status(HttpStatus.UNAUTHORIZED)
    ...
    public ResponseEntity<ExceptionBody> handleMethodArgumentNotValidException(
        ...
        log.error(
                "An attempt to modify or create a resource " +
                        "with malformed data was made: {}",
                e.getMessage(),
                e);
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
